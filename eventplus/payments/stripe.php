    ...
    function submit() {
        ...
        <form action="<?php echo $this->fields['stripe_process_url']; ?>" method="POST">
            <div>
                ...
                <script data-locale="<?php echo $lang; ?>" src="<?php echo $this->jsSrc; ?>" class="stripe-button" 
                        data-key="<?php echo $this->companyOptions['publishable_key']; ?>"  
                        data-amount="<?php echo str_replace($search, $replace, $amount); ?>"  data-currency = "<?php echo "$currency"; ?>" />
                </script>
