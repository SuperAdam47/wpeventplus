<div class="postbox">
    <div class="inside">
        <div class="padding">
            ...
            <br>
            <span class="steptitle"><img class="stepimg"
                                         src="<?php echo $this->assetUrl('images/check-icon.png'); ?>"><?php _e('Choose Event\'s Time', 'evrplus_language'); ?></span>
            <div class="form-table">
                ...
                <p class="p2"><label><?php _e('End Date', 'evrplus_language'); ?></label><label
                            for="end_date"><?php echo EventPlus_Helpers_Funx::dateSelector("\"end", strtotime($end_date)); ?></label>
                ...
                <div class="recurrence_options">
                    ...
                    <p><label class="tooltip" for="recurrence_frequency">
                            <?php _e('Repeat number of times', 'evrplus_language'); ?></label></p>
                    <p class="cs2"
                       title="<?php _e('Enter the number of times you want the event to occur.', 'evrplus_language'); ?>"></p>
                    <br/>
                    <input class="recurrence_frequency" name="recurrence_frequency"
                           value="<?php echo $recurrence_frequency; ?>" type="number" min="0" max="100"></p>

                    <p><label class="tooltip" for="recurrence_repeat">
                    <?php _e('Gaps per repeat', 'evrplus_language'); ?><p class="cs2"
                                                                          title="<?php _e('Enter the repetition period', 'evrplus_language'); ?>"></p>
                    <br/>
                    <input class="recurrence_repeat_period" name="recurrence_repeat_period"
                           value="<?php echo $recurrence_repeat_period; ?>" type="number" min="0" max="100"></p>
                </div>
